    ...
    <body>
        ...
        <div class="grid">
            ...
            <div class="btnVacunaciones" id="divVacunaciones">
                <button class="tablink" id="btnVacunacion" style="background-color: orange;" onclick="location.href = './vacunacion.php';">Vacunación</button>
            </div>            
        ...
        <iframe title="Vacunacion - Vacunación" width="1900" height="1060" src="https://app.powerbi.com/view?r=eyJrIjoiNTQ2ZjUzYzgtYzNkZS00YWQ3LWI4NDYtMjYwNGFjZTIyNzcyIiwidCI6ImY3ZGY1NjA1LWE4OGItNDRkMy05NDFkLWIzMGQ3MjE3M2JjNCIsImMiOjh9" frameborder="0" allowFullScreen="true"></iframe>
        <?php
        //INCLUIMOS EL FOOTER
        include './footer.php';
        ?>
