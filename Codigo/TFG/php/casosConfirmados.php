    ...
    <body>
        ...
        <div class="grid">
            <div class="btnCasos" id="divCasos">
                <button class="tablink" id="btnCaso" style="background-color: orange;" onclick="location.href = './casosConfirmados.php';">Casos confirmados</button>
            </div>
        ...
        <iframe title="Análisis Covid - Número de casos Provinc" width="1900" height="1060" src="https://app.powerbi.com/view?r=eyJrIjoiYWYzNWU5YmMtNzhkNy00YTY3LWI5YWYtMWQ5NGJjYzNiMjY3IiwidCI6ImY3ZGY1NjA1LWE4OGItNDRkMy05NDFkLWIzMGQ3MjE3M2JjNCIsImMiOjh9" frameborder="0" allowFullScreen="true"></iframe>
        <?php
        //INCLUIMOS EL FOOTER
        include './footer.php';
        ?>
