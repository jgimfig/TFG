    ...
    <body>
        ...
        <div class="grid">
            ...
            <div class="btnHospitalizaciones" id="divHospitalizaciones">
                <button class="tablink" id="btnHospitalizacion" style="background-color: orange;" onclick="location.href = './hospitalizaciones.php';">Hospitalizaciones</button>
            </div>
        ...
        <iframe title="Hospitalizaciones - Hospitalizaciones Provinc" width="1900" height="1060" src="https://app.powerbi.com/view?r=eyJrIjoiMzUzZmIyMzMtYTM3MS00NjIzLWI5ZTMtOTFkM2IwNDFlYjI0IiwidCI6ImY3ZGY1NjA1LWE4OGItNDRkMy05NDFkLWIzMGQ3MjE3M2JjNCIsImMiOjh9" frameborder="0" allowFullScreen="true"></iframe>
        <?php
        //INCLUIMOS EL FOOTER
        include './footer.php';
        ?>
